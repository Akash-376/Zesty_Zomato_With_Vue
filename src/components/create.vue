    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" name="dishName" v-model="dishName">
            </div>

            <div class="form-group">
                <label for="image">Image URL:</label>
                <input type="url" name="image" v-model="image">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="availability" v-model="availability">
                    <option value="true">Available</option>
                    <option value="false">Not Available</option>
                </select>
            </div>

            <button v-on:click="addDish()">Add</button>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async addDish() {
            let result = await axios.post('http://localhost:5000/dishes', {
